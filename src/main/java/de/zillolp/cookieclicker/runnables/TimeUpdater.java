...
public class TimeUpdater implements Runnable {
    ...
    public HashMap<String, Long> cachedData;
    private int taskID;
    ...
    public TimeUpdater() {
        ...
        for (String key : configUtil.getConfigurationSection("StatsWalls.Time").getKeys(false)) {
            LocationTools locationToolsHead = new LocationTools("StatsWalls.Time." + key + ".head");
            LocationTools locationToolsSign = new LocationTools("StatsWalls.Time." + key + ".sign");
            ...
            statsWallLocations.put(locationToolsHead.loadLocation(), key + "_Time" + "_head");
            statsWallLocations.put(locationToolsSign.loadLocation(), key + "_Time" + "_sign");
        }
    ...
    public void reload() {
        cookieClicker.getTimeUpdater().stop();
        cookieClicker.setTimeUpdater(this);
    }
